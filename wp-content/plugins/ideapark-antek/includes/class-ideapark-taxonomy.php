...
$ideapark_antek_sort_notice = [];

class Ideapark_Antek_Taxonomy {
	...
	public function register_taxonomy() {
		...
		$labels = [
			...
			'parent_item'       => sprintf( esc_html__( 'Parent %s', 'ideapark-antek' ), $this->single ),
			...
			'update_item'       => sprintf( esc_html__( 'Update %s', 'ideapark-antek' ), $this->single ),
			'add_new_item'      => sprintf( esc_html__( 'Add New %s', 'ideapark-antek' ), $this->single ),
			'new_item_name'     => sprintf( esc_html__( 'New %s', 'ideapark-antek' ), $this->single ),
		...
		if ( ! empty( $args['sort_notice'] ) ) {
			...
			$ideapark_antek_sort_notice[$this->taxonomy] = $args['sort_notice'];
