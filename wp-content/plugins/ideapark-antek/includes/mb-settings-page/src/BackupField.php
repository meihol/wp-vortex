...
class RWMB_Backup_Field extends RWMB_Textarea_Field {
	...
	public static function normalize( $field ) {
		$field = wp_parse_args( $field, [
			'rows'       => 5,
			'desc'       => __( 'To export settings, copy the content of this field and save to a file. To import settings, paste the content of the backup file here.', 'ideapark-antek' ),
			'attributes' => [
				'onclick' => 'this.select()',
			],
		] );
