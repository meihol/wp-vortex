...
class MB_Term_Meta_Box extends RW_Meta_Box {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'mb-term-meta', $url . 'assets/css/term-meta.css', [], IDEAPARK_ANTEK_FUNC_VERSION );

		// Only load these scripts on add term page.
		$screen = get_current_screen();
		if ( 'edit-tags' === $screen->base ) {
			wp_enqueue_script( 'mb-term-meta-wysiwyg-save', $url . 'assets/js/wysiwyg-save.js', [ 'jquery' ], IDEAPARK_ANTEK_FUNC_VERSION, true );
			wp_enqueue_script( 'mb-term-meta-message', $url . 'assets/js/message.js', [ 'jquery' ], IDEAPARK_ANTEK_FUNC_VERSION, true );
			wp_localize_script( 'mb-term-meta-message', 'MBTermMeta', [
				'addedMessage' => __( 'Term added.', 'ideapark-antek' ),
			] );
		}
	}
