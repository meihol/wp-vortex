...
?>
<div class="c-cart__form woocommerce-shipping-fields">
	<?php if ( true === WC()->cart->needs_shipping_address() ) : ?>
		...
		<h3 id="ship-to-different-address">
			<label for="ship-to-different-address-checkbox" class="checkbox">
				...
				<?php esc_html_e( 'Ship to a different address?', 'antek' ); ?></label>
		</h3>
...
<div class="c-cart__form woocommerce-additional-fields">
	...
	<?php if ( apply_filters( 'woocommerce_enable_order_notes_field', 'yes' === get_option( 'woocommerce_enable_order_comments', 'yes' ) ) ) : ?>
		...
		<?php if ( ! WC()->cart->needs_shipping() || wc_ship_to_billing_address_only() ) : ?>
			...
			<h3><?php esc_html_e( 'Additional information', 'antek' ); ?></h3>
