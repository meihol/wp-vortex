		...
		if ( ( $is_section = ( 'section' === $element->get_name() && 'section_background' === $section_id ) ) || ( $is_column = ( 'column' === $element->get_name() && 'section_style' === $section_id ) ) ) {
			...
			if ( $is_column ) {
				...
				$element->add_responsive_control(
					'max_width',
					[
						'label'      => __( 'Max width of the block', 'ideapark-antek' ),
			...
			if ( $is_section ) {
				...
				$element->start_controls_section(
					...
					[
						'tab'   => Controls_Manager::TAB_STYLE,
						'label' => __( 'Columns Align', 'ideapark-antek' ),
					]
				);
				...
				$element->add_responsive_control(
					...
					[
						'label'     => __( 'Column alignment', 'ideapark-antek' ),
						...
						'options'   => [
							...
							'space-between' => [
								'title' => __( 'Space between', 'ideapark-antek' ),
