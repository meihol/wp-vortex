...
;(function ($, window, document, undefined) {
	...
	Owl.prototype.onResize = function () {
		...
		if (this._width === this.$element.width() && this.settings.responsive === false) {
			return false;
		}
	 ...
	 * @param {Boolean} [is_nav] - Prev / Next.
	 */
...
;(function ($, window, document, undefined) {
	...
	Navigation.prototype.draw = function () {
		...
		if (settings.nav) {
			...
			if (settings.autoWidth && this._controls.$previous.hasClass('disabled') && this._controls.$next.hasClass('disabled')) {
				this._controls.$relative.toggleClass('disabled', true);
			}
		}
		...
		if (settings.dots) {
			...
			if (settings.autoWidth && this._pages.length === 1) {
				this._controls.$absolute.toggleClass('disabled', true);
			}
		...
		var is_dots_disabled = this._controls.$absolute.hasClass('disabled');
		if ( is_dots_disabled && this.$element.hasClass('owl-dotted')) {
			this.$element.removeClass('owl-dotted');
		} else if (! is_dots_disabled && ! this.$element.hasClass('owl-dotted')) {
